...
try:
    ...
    from src.processing.esignature.audit import create_audit_event, sha256_file
    from src.processing.esignature.certificate import generate_completion_certificate
    from src.processing.esignature.envelope import (
        EnvelopeState,
    ...
    from src.processing.esignature.fields import (
        fields_for_signer,
        normalize_email,
    ...
    from src.processing.esignature.preview import generate_step_preview
    from src.processing.esignature.signing import apply_signer_fields_to_pdf
    from src.processing.esignature.tokens import (
        SigningToken,
        StoredSigningToken,
        build_signing_url,
