...
export const esignaturePageTranslations = {
  en: {
    ...
    ownerTextRequired: "Enter a value for each required owner text field.",
    badRectangle:
  ...
  fr: {
    ...
    ownerTextRequired: "Saisissez une valeur pour chaque champ texte obligatoire du propriétaire.",
