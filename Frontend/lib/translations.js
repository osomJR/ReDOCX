...
export const errorTranslations = {
  en: {
      ...
      SUMMARIZATION_QUALITY_FAILED: "We couldn't verify the integrity of this summary. Please try again.",
  ...
  fr: {
      ...
      SUMMARIZATION_QUALITY_FAILED: "Nous n’avons pas pu vérifier l’intégrité de ce résumé. Réessayez.",
...
export const backendErrorCodeAliases = {
  ...
  ai_output_truncated: "UPSTREAM_SERVICE_ERROR",
  ai_output_incomplete: "UPSTREAM_SERVICE_ERROR",
  ai_provider_failed: "UPSTREAM_SERVICE_ERROR",
  ai_provider_invalid_status: "UPSTREAM_SERVICE_ERROR",
