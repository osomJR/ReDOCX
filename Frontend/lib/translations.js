...
export const esignaturePageTranslations = {
  en: {
    back: "Back",
    badge: "ReDOCX Sign",
    title: "Sign a PDF or send it for signature",
    description:
  ...
  fr: {
    back: "Retour",
    badge: "ReDOCX Sign",
    title: "Signer un PDF ou l’envoyer pour signature",
    description:
    ...
    uploadTitle: "1. Choisissez votre PDF",
    uploadHelp: "Autorisé : .pdf uniquement. Maximum 100 Mo.",
    chooseFile: "Choisir un PDF",
