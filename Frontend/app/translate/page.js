  ...
  async function handleSubmit(event) {
    ...
    try {
      if (mode === "file" && selectedFiles.length > 1) {
        ...
        const data = await postAnalyzerBatchFeature("translate", formData);
        setBatchResult(data);
        return;
      }
      ...
      const artifactDownloadUrl = getAnalyzerResultDownloadUrl(result);
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-12 md:px-8 md:py-16">
          ...
          <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            >
              ...
              <BatchResultPanel
                result={batchResult}
                title={getPageRuntimeCopy("translate", language).batchResultsTitle}
              />
              <ProductionOutputActions
                result={batchResult}
                title={getPageRuntimeCopy("translate", language).batchOutputTitle}
              />
            </form>
            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-3xl border border-[var(--app-border)] bg-[var(--app-surface-strong)] p-6 backdrop-blur-xl">
                ...
                {downloadUrl && (
                  ...
                  >
                    {getPageRuntimeCopy("translate", language).downloadFile}
                  </a>
                )}
                <ProductionOutputActions
                  ...
                  title={getPageRuntimeCopy("translate", language).outputTitle}
                />
