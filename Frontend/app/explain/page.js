        ...
        <div className="relative mx-auto max-w-5xl px-6 py-12 md:px-8 md:py-16">
          ...
          <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            >
              ...
              <BatchResultPanel
                result={batchResult}
                title={getPageRuntimeCopy("explain", language).batchResultsTitle}
              />
              <ProductionOutputActions
                result={batchResult}
                title={getPageRuntimeCopy("explain", language).batchOutputTitle}
                language={language}
                account={account}
              />
            </form>
                ...
                {downloadInfo && (
                  <div className="rounded-2xl border border-[var(--app-border)] bg-[var(--app-panel)] p-4">
                    <div className="space-y-2 text-sm app-text-muted">
                      <p>
                        <span className="font-medium text-[var(--app-text)]">
                          {getPageRuntimeCopy("explain", language).fileLabel}
                        </span>{" "}
                        {downloadInfo.filename}
                      </p>
                      <p>
                        <span className="font-medium text-[var(--app-text)]">
                          {getPageRuntimeCopy("explain", language).formatLabel}
                        </span>{" "}
                        {downloadInfo.outputFormat}
                      </p>
                      <p>
                        <span className="font-medium text-[var(--app-text)]">
                          {getPageRuntimeCopy("explain", language).sizeLabel}
                        </span>{" "}
                    ...
                    >
                      {getPageRuntimeCopy("explain", language).downloadFile}
                    </a>
                  </div>
                )}
                <ProductionOutputActions
                  ...
                  title={getPageRuntimeCopy("explain", language).outputTitle}
                  language={language}
                  account={account}
                />
