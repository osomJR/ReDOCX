...
const ALLOWED_FEATURE_PATHS = new Set([
  ...
  "generate-questions",
  "generate-answers",
  "sensitive-data-protection/redact",
  "sensitive-data-protection/redact/detect-document-type",
  "sensitive-data-protection/data-mask",
  "sensitive-data-protection/data-mask/detect-document-type",
  "compliance",
